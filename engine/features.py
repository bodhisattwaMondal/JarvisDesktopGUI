...
def findContact(query):
    ...
    words_to_remove = [ASSISTANT_NAME, 'make', 'a', 'an', 'to', 'phone', 'call', 'email', 'mail', 'gmail', 'send', 'message', 'whatsapp', 'video', 'open', 'and', 'please']
...
#         speak(f"i am not sure, but i think we are in {city} city of {state} state of {country} country")
#         speak(f"and , we are in {tZ} timezone the latitude os our location is {latidute}, and the longitude of our location is {longitude}, and we are using {org}\'s network ")
#         return city
#     except Exception as e:
